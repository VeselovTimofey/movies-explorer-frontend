    ...
    return (
      <section className="techs section" id="techs">
        ...
        <ul className="techs__list">
          ...
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">CSS</div>
          </li>
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">JS</div>
          </li>
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">React</div>
          </li>
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">Git</div>
          </li>
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">Express.js</div>
          </li>
          <li>
            <div className="techs__element reqular-font reqular-font_size_small">mongoDB</div>
          </li>
        </ul>
      </section>
    )
